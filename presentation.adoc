...
* Качать сотни гигабайт - долго: > 1ч
...
WGFO собирает полный комплект бинов/пэкеджей за 1ч 15мин
...
100 символов, Карл! (https://issues.jenkins-ci.org/browse/JENKINS-31209[JENKINS-31209], >= 2.198)
